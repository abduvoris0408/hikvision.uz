...
import { Star, Heart, ShoppingCart, Share2, Phone, Truck, Shield, Award, ChevronLeft, ChevronRight } from "lucide-react"
        ...
        <div className="space-y-4">
          ...
          <div className="relative aspect-square overflow-hidden rounded-lg bg-gray-100">
            ...
            <div className="absolute top-4 left-4 flex flex-col gap-2">
              {product.isNew && <Badge className="bg-green-500 hover:bg-green-600 text-white">YANGI</Badge>}
              {product.isBestSeller && <Badge className="bg-red-500 hover:bg-red-600 text-white">YANGI</Badge>}
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">({product.reviewCount} fikr-mulohaza)</span>
            </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-center gap-2">
                <div className="w-2 h-2 bg-secondary rounded-full" />2 yil kafolat
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <Button variant="outline" className="w-full bg-transparent" size="lg">
              ...
              Qo'ng'iroq qiling: +998 99 213 48 63
            </Button>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 pt-6 border-t">
            <div className="text-center space-y-2">
              ...
              <div className="text-sm font-medium">Tez yetkazib berish</div>
              <div className="text-xs text-muted-foreground">1-3 kun ichida</div>
            </div>
            <div className="text-center space-y-2">
              <Shield className="h-8 w-8 mx-auto text-secondary" />
              <div className="text-sm font-medium">2 yil kafolat</div>
              <div className="text-xs text-muted-foreground">Rasmiy kafolat</div>
            </div>
            <div className="text-center space-y-2">
              <Award className="h-8 w-8 mx-auto text-secondary" />
              <div className="text-sm font-medium">Sifat kafolati</div>
              <div className="text-xs text-muted-foreground">100% original</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <CardContent className="p-6">
          <Tabs defaultValue="description" className="w-full">
            ...
            <TabsContent value="description" className="mt-6 space-y-4">
              <h3 className="text-lg font-semibold">Mahsulot haqida</h3>
            ...
            <TabsContent value="specifications" className="mt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold">Texnik xususiyatlar</h3>
                  <div className="space-y-3">
                    <div className="flex justify-between py-2 border-b">
                      <span className="text-muted-foreground">Sensor turi:</span>
                      <span>CMOS</span>
                    </div>
                    <div className="flex justify-between py-2 border-b">
                      <span className="text-muted-foreground">Ruxsat:</span>
                      <span>4K (3840×2160)</span>
                    </div>
                    <div className="flex justify-between py-2 border-b">
                      <span className="text-muted-foreground">Ob'ektiv:</span>
                      <span>2.8-12mm</span>
                    </div>
                    <div className="flex justify-between py-2 border-b">
                      <span className="text-muted-foreground">Tungi ko'rish:</span>
                      <span>30m gacha</span>
                    </div>
                  </div>
                </div>
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between py-2 border-b">
                      <span className="text-muted-foreground">Himoya darajasi:</span>
                      <span>IP67</span>
                    </div>
                    <div className="flex justify-between py-2 border-b">
                      <span className="text-muted-foreground">Quvvat:</span>
                      <span>12V DC</span>
                    </div>
                    <div className="flex justify-between py-2 border-b">
            ...
            <TabsContent value="reviews" className="mt-6 space-y-6">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold">Mijozlar sharhlari</h3>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 space-y-2">
                        <div className="flex items-center gap-2">
                          <span className="font-medium">Aziz</span>
                          <div className="flex">{renderStars(5)}</div>
                        </div>
                        <p className="text-sm text-muted-foreground">
                          Juda yaxshi kamera, sifati zo'r. Tez yetkazib berishdi va o'rnatishda yordam berishdi.
                        </p>
                ...
                <Card>
                  <CardContent className="p-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 space-y-2">
                        <div className="flex items-center gap-2">
                          <span className="font-medium">Murod</span>
                          <div className="flex">{renderStars(4)}</div>
                        </div>
                        <p className="text-sm text-muted-foreground">
                          Narxi mos, sifati yaxshi. Tungi ko'rish funksiyasi juda yaxshi ishlaydi.
                        </p>
            ...
            <TabsContent value="delivery" className="mt-6 space-y-4">
              <h3 className="text-lg font-semibold">Yetkazib berish va to'lov</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
